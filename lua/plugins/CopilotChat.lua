...
return {
  { import = "lazyvim.plugins.extras.coding.copilot" }, -- Or use { import = "lazyvim.plugins.extras.coding.copilot" },
  {
    ...
    config = function(_, opts)
      ...
      -- Function to explain the entire buffer content
      function explain_buffer_to_copilot()
        local lines = vim.api.nvim_buf_get_lines(0, 0, -1, false)
        local code = table.concat(lines, "\n")
        local prompt = "Explain this code:"
        local full_prompt = prompt .. "\n\n" .. code
        vim.cmd("CopilotChat " .. vim.fn.shellescape(full_prompt))
      end

      -- Command to invoke the explanation function
      vim.api.nvim_create_user_command("CopilotChatExplainWithCode", explain_buffer_to_copilot, {})
    end,
    event = "VeryLazy",
    keys = {
      {
